...
if(PDF_EXPORT){
  cat("View this CV online with links at 
      https://github.com/nuhorchak/resume/pdfs/uhorchak_cv.pdf")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/nuhorchak/resume/tree/master/pdfs/uhorchak_cv.pdf)")
}
```
